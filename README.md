...
This version of `lamp` is designed to work with GENIE `R-2_12_4`! It should
...
recommended tag is `R-2_12_4.0`. Use the following command to check
...
cloning the repository, `cd` into the `lamp` directory and run:
    ...
    git checkout -b R-2_12_4.0-br R-2_12_4.0
...
This will checkout _tag_ `R-2_12_4.0` into _branch_ `R-2_12_4.0-br`. You want to
...
* The latest version is 2.12.4. To use 2.12.4, you want tag "R-2_12_4.0":
