...
This version of `lamp` is designed to work with GENIE `R-2_10_4`! It will
...
recommended tag is `R-2_10_4.0`. Use the following command to check
...
GENIE `R-2_10_4`, and you will need to check out an older release of `lamp` to
...
no arguments will produce the help menu:
    ...
    Usage: ./rub_the_lamp.sh -<flag>
      ...
      All defaults:  
        ./rub_the_lamp.sh
      Produces: R-2_10_4 from HepForge, Pythia6, ROOT v5-34-24
